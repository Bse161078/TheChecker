...
enum CleaningActions { cleaned, notCleaned, damaged, notAvailable }
        ...
        Container(
          ...
          decoration: BoxDecoration(
              color: state == CleaningActions.cleaned
                  ? greenColor
                  : state == CleaningActions.notCleaned
                      ? redColor
                      : state == CleaningActions.notAvailable
                          ? redColor
                          : Colors.amber,
          ...
          child: Row(
            ...
            children: [
              Text(state == CleaningActions.cleaned
                      ? 'cleaned'.tr
                      : state == CleaningActions.notCleaned
                          ? 'not_cleaned'.tr
                          : state == CleaningActions.notAvailable
