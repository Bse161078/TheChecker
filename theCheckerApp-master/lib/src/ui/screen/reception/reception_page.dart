...
import 'package:checkerapp/src/ui/screen/reception/widgets/alert_view.dart';
import 'package:checkerapp/src/ui/screen/reception/widgets/damages_actions_view.dart';
import 'package:checkerapp/src/ui/screen/reception/widgets/room_row_view.dart';
import 'package:checkerapp/src/ui/screen/reception/widgets/status_actions_view.dart';
...
import 'widgets/cleaning_actions_view.dart';
...
class Reception extends GetView<ReceptionController>{
  ...
  Widget build(BuildContext context) {
    return GetX<ReceptionController>(
      initState: (_){
        controller.getRooms();
        ...
        return Scaffold(
          ...
          body: Column(
            children: [
              ...
              if(_.isLoading) ... [
                Expanded(child: Center(child: SizedBox(width: 24, height: 24, child: CupertinoActivityIndicator())))
              ] else ...[
                  ...
                  children: [
                    ...
                    Expanded(
                      ...
                      child: Row(
                        ...
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [
                          Text('room'.tr, style: Get.textTheme.subtitle1,).setStyle(size: 14).paddingOnly(left: 16),
                        ],
                    ...
                    Expanded(flex: 6,child: Row(
                      ...
                      children: [
                        ...
                        SizedBox(width: 150,child: Text('status'.tr, style: Get.textTheme.subtitle1,).setStyle(size: 14).paddingOnly(left: 0)),
                        SizedBox(width: 180,child: Text('damages'.tr, style: Get.textTheme.subtitle1,).setStyle(size: 14).paddingOnly(left: 0)),
                        SizedBox(width: 155,child: Text('alert'.tr, style: Get.textTheme.subtitle1,).setStyle(size: 14).paddingOnly(left: 0)),
                      ],
                    )),
                  ...
                  child: Container(
                    ...
                    child: ListView.builder(
                      itemBuilder: (BuildContext context, int index) {
                        ...
                        return RoomRowView(label: '${model.name}', type: '${model.roomType?.title}', cleaningStatus: '${model.status}', onTapAlert: () {
  ...
  _submitAlertDialog(BuildContext context, String roomID) {
    Dialog errorDialog = Dialog(
      shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(12.0)), //this right here
      child: SendAlertDialog(roomId: roomID,),
    );
    showDialog(context: context, builder: (BuildContext context) => errorDialog);
  }
