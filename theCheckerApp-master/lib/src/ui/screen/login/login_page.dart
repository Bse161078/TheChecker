        ...
        child: Obx((){
          ...
          return Column(
            ...
            children: <Widget>[
              ...
              Row(
                children: [
                  SizedBox( width: Get.width / 3.5,child: Text('pls_choose_your_lang'.tr, style: Get.textTheme.subtitle1,).setStyle(size: 16).paddingOnly(left: 24, top: 24)),
                ],
              ),

              30.ph,

              SizedBox(width: Get.width / 4.8, child: Checker(label: '${locales[0]['name']}', hasBorder: true, state: Get.locale?.languageCode == 'en', type: CheckerType.Radio , longText: false, onChanged: (value){
                updateLocale(
              ...
              10.ph,
              SizedBox(width: Get.width / 4.8, child: Checker(label: '${locales[1]['name']}', hasBorder: true, state: Get.locale?.languageCode == 'de', type: CheckerType.Radio , longText: false, onChanged: (value){
                updateLocale(
        ...
        body: Stack(
          children: [
                ...
                SizedBox(
                  ...
                  child: Column(
                    ...
                    children: [
                        ...
                        Image.asset('logo'.toPng, width: Get.width / 4.5,),
                        58.ph,

                      TxtField(controller: controllerUser, label: 'username'.tr, ),
                      12.ph,
                      TxtField(controller: controllerPass, label: 'pass'.tr, inputAction: TextInputAction.done, isObscure: _.obscurePass.value, obscureTap: ()=>_.obscurePass.value = !_.obscurePass.value,),
                      12.ph,
                      Btn(label: 'login'.tr, onPressed: ()=>_.enabledLoginButton.value ? _signIn() : null, isLoading: _.isLoading, enabled: _.enabledLoginButton.value,),
            ...
            Align(
              ...
              child: Tap(onTap: () =>_showLocaleDialog(context),
                  child: Row(
