...
class Home extends GetView<RoomsController> {
  ...
  Widget build(BuildContext context) {
    return GetX<RoomsController>(initState: (state) {
          ...
          appBar: token.toString().isEmpty
              ...
              : AppBar(
                  ...
                  title: SvgPicture.asset(
                    'assets/images/splash-artwork.svg',
                    width: 70,
                  ),
                  backgroundColor: backgroundColor,
                ),
          body: token.toString().isEmpty ? guestView() : const TabBarView(children: []),
        ),
      );
    });
  }
