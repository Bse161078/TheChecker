...
class MainRepository {
  ...
  Future<dynamic> login(String userName, String password) async {
    ...
    final response = await ServiceProvider.execute(Routes.login, Method.POST, data, [200]);
    return response;
  }

  Future<dynamic> profile() async {
    final response = await ServiceProvider.execute(Routes.profile, Method.GET, null, [200]);
    return response;
  }

  Future<dynamic> rooms() async {
    final response = await ServiceProvider.execute(Routes.room, Method.GET, null, [200]);
    return response;
  }

  Future<dynamic> cleaners() async {
    final response = await ServiceProvider.execute(Routes.cleaner, Method.GET, null, [200]);
    return response;
  }

  Future<dynamic> setRoomStatus(String roomId, String status) async {
    var data = {"roomID": roomId ,"status": status,};
    final response = await ServiceProvider.execute(Routes.set_room_status, Method.POST, data, [200, 201]);
    return response;
  }

  Future<dynamic> sendAlert(String roomId, String status) async {
    var data = {"roomID": roomId ,"status": status,};
    final response = await ServiceProvider.execute(Routes.send_alert, Method.POST, data, [200, 201]);
    return response;
  }

  Future<dynamic> materials() async {
    final response = await ServiceProvider.execute(Routes.materials, Method.GET, null, [200]);
    return response;
  }
  ...
  Future<dynamic> setMaterial(List<Material> materials, String supplier) async {
    ...
    final response = await ServiceProvider.execute(Routes.set_material, Method.POST, data, [200,201]);
    return response;
  }
  ...
  Future<dynamic> floor(
    ...
    final formData = FormData.fromMap({
      ...
      "roomHasStrongStainsThatCanNotBeCleanedByUsStatus": roomHasStrongStainsThatCanNotBeCleanedByUsStatus,
      "roomHasStrongStainsThatCanNotBeCleanedByUsPhotos": [
        if(roomHasStrongStainsThatCanNotBeCleanedByUsPhotos.isNotEmpty)
          await MultipartFile.fromFile(roomHasStrongStainsThatCanNotBeCleanedByUsPhotos.last)
  ...
  Future<dynamic> shelves(
    ...
    final formData = FormData.fromMap({
      ...
      "BrochuresNotNeatlyAndSortedInTheirPlaceStatus": shelvesAllBrochuresNeatlySorted,
